    ...
    <x-slot name="form">
        ...
        @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
            <div x-data="{photoName: null, photoPreview: null}" class="col-span-6 sm:col-span-4">
                ...
                <x-jet-input-error for="company_photo" class="mt-2" />
            </div>
        @endif
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-jet-input name="company_name" id="company_name" type="text" class="mt-1 block w-full" wire:model.defer="state.company.name" autocomplete="company_name" />
            <x-jet-input-error for="company.name" class="mt-2" />
        </div>

        <!-- Company Profile -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="company_profile" value="{{ __('会社紹介') }}" />
            ...
            <x-jet-input-error for="company.profile" class="mt-2" />
        </div>
    </x-slot>
